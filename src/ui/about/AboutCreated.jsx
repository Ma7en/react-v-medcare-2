...
function AboutCreated({ dataupdate }) {
    ...
    const share = () => {
        let shareDate = {
            ...
            url: `${document.location.origin}/aboutus`,
        };
    ...
    return (
        <>
            <StyledCreated>
                {/* <Heading as="h6">Last Update done in </Heading> */}
                <div className="data">
                    <a>
                        <FaCalendar />
                ...
                <div>
                    <ul>
                        <li>
                            <StyledLink
                                to={`${document.location.origin}/aboutus`}
                                target="_blank"
                            >
                                <HiEye />
                            </StyledLink>
